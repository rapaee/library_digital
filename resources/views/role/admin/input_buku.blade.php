...
<div class="container mx-auto ml-24">
    <h2 class="text-2xl font-bold mb-4 ml-36">Input Buku Baru</h2>
    ...
    <form action="{{ route('input_buku') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 ml-36">
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" class="form-control border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:border-blue-500" id="judul" name="judul" value="{{ old('judul') }}" required>
            @error('judul')
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" class="form-control border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:border-blue-500" id="penulis" name="penulis" value="{{ old('penulis') }}" required>
            @error('penulis')
                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" class="form-control border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:border-blue-500" id="penerbit" name="penerbit" value="{{ old('penerbit') }}" required>
            @error('penerbit')
                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group mb-4">
            ...
            <input type="number" class="form-control border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:border-blue-500" id="kode_buku" name="kode_buku" value="{{ old('kode_buku') }}" required>
            @error('kode_buku')
                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group mb-4">
            ...
            <input type="number" class="form-control border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:border-blue-500" id="stok" name="stok" value="{{ old('stok') }}" required>
            @error('stok')
                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 flex justify-end ml-auto rounded">Simpan Buku</button>
    </form>
</div>
@endsection
